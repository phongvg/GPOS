...
@Component
public class ToppingFoodItemMapperImpl implements ToppingFoodItemMapper {

    @Override
    public ToppingFoodItem dtoToEntity(ToppingFoodItemDto toppingFoodItemDto) {
    ...
    @Override
    public ToppingFoodItemDto entityToDto(ToppingFoodItem toppingFoodItem) {
        ...
        toppingFoodItemDto.setCoFoodItem( coFoodItemToCoFoodItemDto( toppingFoodItem.getCoFoodItem() ) );
    ...
    protected List<ToppingFoodItem> toppingFoodItemDtoListToToppingFoodItemList(List<ToppingFoodItemDto> list) {
        ...
        for ( ToppingFoodItemDto toppingFoodItemDto : list ) {
            list1.add( dtoToEntity( toppingFoodItemDto ) );
        }
