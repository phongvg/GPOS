...
@Component
public class KdsPlaceMapperImpl implements KdsPlaceMapper {

    @Override
    public KdsPlace dtoToEntity(KdsPlaceDto kdsPlaceDto) {
        if ( kdsPlaceDto == null ) {
            return null;
        }
    ...
    @Override
    public KdsPlaceDto entityToDto(KdsPlace kdsPlace) {
        if ( kdsPlace == null ) {
            return null;
        }
    ...
    protected KdsConfigCooking kdsConfigCookingDtoToKdsConfigCooking(KdsConfigCookingDto kdsConfigCookingDto) {
        ...
        kdsConfigCooking.setKdsPlace( dtoToEntity( kdsConfigCookingDto.getKdsPlace() ) );
