...
@Component
public class ParamMapperImpl implements ParamMapper {

    @Override
    public Param dtoToEntity(ParamDto paramDto) {
        if ( paramDto == null ) {
            return null;
        }
        ...
        param.setGroupParam( groupParamDtoToGroupParam( paramDto.getGroupParam() ) );

        return param;
    }

    @Override
    public ParamDto entityToDto(Param param) {
        if ( param == null ) {
            return null;
        }
        ...
        paramDto.setGroupParam( groupParamToGroupParamDto( param.getGroupParam() ) );

        return paramDto;
    }

    @Override
    public GroupParamDto groupParamToGroupParamDto(GroupParam groupParam) {
        if ( groupParam == null ) {
            return null;
        }
    ...
    protected List<Param> paramDtoListToParamList(List<ParamDto> list) {
        ...
        for ( ParamDto paramDto : list ) {
            list1.add( dtoToEntity( paramDto ) );
        }

        return list1;
    }

    protected GroupParam groupParamDtoToGroupParam(GroupParamDto groupParamDto) {
