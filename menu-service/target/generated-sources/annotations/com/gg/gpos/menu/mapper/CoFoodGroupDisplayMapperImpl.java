...
@Component
public class CoFoodGroupDisplayMapperImpl implements CoFoodGroupDisplayMapper {

    @Override
    public CoFoodGroupDisplay dtoToEntity(CoFoodGroupDisplayDto coFoodGroupDisplayDto) {
        ...
        coFoodGroupDisplay.setCoCategory( coCategoryDtoToCoCategory( coFoodGroupDisplayDto.getCoCategory() ) );

        return coFoodGroupDisplay;
    }

    @Override
    public CoFoodGroupDisplayDto entityToDto(CoFoodGroupDisplay coFoodGroupDisplay) {
        ...
        coFoodGroupDisplayDto.setCoCategory( coCategoryToCoCategoryDto( coFoodGroupDisplay.getCoCategory() ) );

        return coFoodGroupDisplayDto;
    }

    @Override
    public CoCategoryDto coCategoryToCoCategoryDto(CoCategory coCategory) {
        if ( coCategory == null ) {
            return null;
        }
        ...
        coCategoryDto.setDigitalMenus( null );
        coCategoryDto.setCoFoodGroupDisplays( null );
        coCategoryDto.setSoCategory( null );
    ...
    protected List<CoFoodGroupDisplay> coFoodGroupDisplayDtoListToCoFoodGroupDisplayList(List<CoFoodGroupDisplayDto> list) {
        ...
        for ( CoFoodGroupDisplayDto coFoodGroupDisplayDto : list ) {
            list1.add( dtoToEntity( coFoodGroupDisplayDto ) );
        }
    ...
    protected DigitalMenu digitalMenuDtoToDigitalMenu(DigitalMenuDto digitalMenuDto) {
        ...
        digitalMenu.setCoCategory( coCategoryDtoToCoCategory( digitalMenuDto.getCoCategory() ) );
    ...
    protected CoCategory coCategoryDtoToCoCategory(CoCategoryDto coCategoryDto) {
