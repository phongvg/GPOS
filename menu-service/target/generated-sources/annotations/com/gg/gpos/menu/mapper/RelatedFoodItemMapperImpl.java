...
@Component
public class RelatedFoodItemMapperImpl implements RelatedFoodItemMapper {

    @Override
    public RelatedFoodItem dtoToEntity(RelatedFoodItemDto relatedFoodItemDto) {
    ...
    @Override
    public RelatedFoodItemDto entityToDto(RelatedFoodItem relatedFoodItem) {
        ...
        relatedFoodItemDto.setCoFoodItem( coFoodItemToCoFoodItemDto( relatedFoodItem.getCoFoodItem() ) );
    ...
    protected List<RelatedFoodItem> relatedFoodItemDtoListToRelatedFoodItemList(List<RelatedFoodItemDto> list) {
        ...
        for ( RelatedFoodItemDto relatedFoodItemDto : list ) {
            list1.add( dtoToEntity( relatedFoodItemDto ) );
        }
