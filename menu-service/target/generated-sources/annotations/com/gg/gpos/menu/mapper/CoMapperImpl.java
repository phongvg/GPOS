...
@Component
public class CoMapperImpl implements CoMapper {

    @Override
    public Co dtoToEntity(CoDto coDto) {
        if ( coDto == null ) {
            return null;
        }
    ...
    @Override
    public CoDto entityToDto(Co co) {
        if ( co == null ) {
            return null;
        }
    ...
    protected CoFoodItem coFoodItemDtoToCoFoodItem(CoFoodItemDto coFoodItemDto) {
        ...
        coFoodItem.setCo( dtoToEntity( coFoodItemDto.getCo() ) );
