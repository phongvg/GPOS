...
public interface ToppingFoodItemMapper {
	ToppingFoodItem dtoToEntity(ToppingFoodItemDto toppingFoodItemDto);
	ToppingFoodItemDto entityToDto(ToppingFoodItem toppingFoodItem);
