...
var foodItemForm = function() {
	//
    // Setup module components
    //

    // Bootstrap file upload
    var _componentFoodItemForm = function() {
        if (!$().fileinput) {
...
var foodItemComponent = {
		...
		initPhotos : function(){
			...
			var contextPath = getContext();
			$.ajax({
				url : contextPath + '/foodItem/loadPhotos',
				method : 'GET',
				data : {id : foodItemId},
		...
		delPhoto : function(aId) {
            var contextPath = getContext();
            $.ajax({
                url : contextPath + '/foodItem/del/photo',
                method : 'POST',
                data : {aId : aId},
                success : function(res){
                    foodItemComponent.initPhotos();
                },
                error : function(e){
                    console.log(e);
                }
