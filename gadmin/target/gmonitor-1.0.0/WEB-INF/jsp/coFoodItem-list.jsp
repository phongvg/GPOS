...
<!-- Content area -->
<div class="content">
	<form:form id="coFoodItemForm" modelAttribute="criteria" action="${ctx}/coFoodItem/list?rCode=${criteria.restaurantCode}"  method="post">
		...
		<div class="card-body">
			...
			<fieldset class="mb-3">
				...
				<div class="tab-content">
					<!--cau hinh menu  -->
					<div class="card">
						<div class="card-header header-elements-inline"><span class="text-uppercase font-size-lg font-weight-bold"><fmt:message key="list.FoodItem.in.co"/></span></div>
						...
						<div class="card-body">
							<div class="card">
							<div class="card-header header-elements-inline">
								<span class="text-uppercase font-size-lg font-weight-bold"><fmt:message key="list.FoodItem.in.co"/></span>
							</div>
							<div class="card-body">
						    	<div class="row">
									...
									<div class="col-md-2"><form:input class="form-control" type="text" path="nameVn" placeholder="Nhập tên món ăn..."/></div>
			  						<div class="col-md-3">
			  							...
			  							<security:authorize access="hasAnyRole('ROLE_RES_CONFIG_EDIT')">
	  										<a type="button" class="btn btn-light" href="<c:url value='/export/coFoodItem?resCode=${criteria.restaurantCode}'/>" id="btnExport"> <i class="icon-cloud-upload2"></i> <fmt:message key="button.export"/></a>
					               		</security:authorize>
			  						</div>
						    	</div>
						    	<div class="row float-right">
									<a href="<c:url value='/coFoodItem/form?rCode=${criteria.restaurantCode }&coId=${coId}'/>" type="button" class="btn btn-sm btn-primary" title="<fmt:message key="button.add"/>"><i class="icon-plus22"></i><fmt:message key="button.add"/></a>
	  								<a href="<c:url value='/res/coFoodItem/changed?rCode=${criteria.restaurantCode }&coId=${coId}'/>" type="button" class="btn btn-sm btn-primary" title="<fmt:message key="button.list.co.fooditem.changed"/>"><fmt:message key="button.list.co.fooditem.changed"/></a>
								</div>
							</div>
