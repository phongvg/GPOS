...
<div class="content">
	...
	<div class="card">
		<div class="card-header header-elements-inline">
			<span class="text-uppercase font-size-lg font-weight-bold"><fmt:message key="co.sync"/></span>
		...
		<div class="card-body">
			...
			<fieldset class="mb-3">
				<legend class="text-uppercase font-size-sm font-weight-bold"><fmt:message key="co.sync"/></legend>
				<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
					<li class="nav-item"><a href="#" class="nav-link">Cấu hình CO</a></li>
					<li class="nav-item"><a href="<c:url value="/so/list?oId=${criteria.getOwnerId() }&t=${criteria.getOwnerType() }"/>" class="nav-link">Cấu hình SO</a></li>
					<li class="nav-item"><a href="<c:url value="/co/sync"/>" class="nav-link active"><fmt:message key="co.sync"/></a></li>
				</ul>
