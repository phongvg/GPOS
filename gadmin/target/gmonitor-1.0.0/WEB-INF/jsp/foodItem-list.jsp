...
<form:form id="foodItemListForm" modelAttribute="criteria" action="${ctx}/foodItem/list?rId=${criteria.ownerId }"  method="post">
				...
				<div class="tab-content">
					...
					<div class="card">
						...
						<ul class="nav nav-tabs">
							...
							<li class="nav-item"><a href="<c:url value="/foodGroup/list?rId=${criteria.ownerId}"/>" class="nav-link"><fmt:message key="tab.menu.foodGroup"/></a></li>
						...
						<div class="card-body">
							<div class="list-icons" style="float: right">
								<a href="<c:url value='/foodItem/form?rId=${criteria.ownerId}'/>" class="btn btn-sm btn-primary" title="<fmt:message key="button.add"/>" style=" margin-top: -25%; margin-bottom: 15%"><i class="icon-plus22"></i><fmt:message key="button.add"/></a>
			               	</div>
				               	...
				               	<table class="table table-bordered table-striped">
									<thead>
										<tr class="table-success">
											...
											<th><fmt:message key="foodItem.parent"/></th>
									...
									<tbody>
										...
										<c:forEach items="${page.content}" var="foodItem" varStatus="cnt">
											<tr>
												...
												<td>${foodItem.descVn}</td>
												<td>${foodItem.descEn}</td>
												<td>${foodItem.parent.nameVn}</td>
												<td class="text-left">
													<div class="list-icons">
								                		<a href="<c:url value='/ref/foodItem/form?id=${foodItem.id}'/>" class="list-icons-item text-primary-600" title="<fmt:message key='button.edit'/>" data-container="body"><i class="icon-pencil7"></i></a>
															...
															<div class="modal-dialog modal-md">
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		<p><fmt:message key="confirm.delete.question"/> <span style="color: blue;">${foodItem.nameVn}</span></p>
																	</div>
																	<div class="modal-footer">
																		<button type="button" class="btn btn-warning" data-dismiss="modal"><fmt:message key="button.cancel"/></button>
																		<a href="<c:url value='/foodItem/del/${foodItem.id}' />" id="confirm"  class="btn btn-primary"><fmt:message key="button.confirm"/></a>
																	</div>
																</div>
															</div>
														</div>
