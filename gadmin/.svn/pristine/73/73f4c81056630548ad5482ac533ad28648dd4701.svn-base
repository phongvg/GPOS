...
<head>
	...
	<script src="<c:url value='/themes/admin/assets/js/cag/group-param/group_param_form.js'/>"></script>
</head>

<div class="content">
	<form:form id="groupParamForm" action="${ctx}/cag/group-param/save" method="post" modelAttribute="groupParam">
			...
			<div class="card-body">
				...
				<fieldset class="mb-3">
					...
					<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
						...
						<li class="nav-item"><a href="javascript:GroupParamForm.check('<c:url value="/cag/group-param/param-list"/>',${groupParam.id});" class="nav-link"><i class="icon-hammer-wrench mr-2"></i><fmt:message key="tab.param"/></a></li>
						<li class="nav-item"><a href="javascript:GroupParamForm.check('<c:url value="/cag/group-param/sync-to-restaurant"/>',${groupParam.id});" class="nav-link"><i class="icon-flip-vertical3 mr-2"></i><fmt:message key="tab.so.apply"/></a></li>
					</ul>
