...
<body>
	...
	<div class="navbar navbar-expand-md navbar-dark">
		<div class="navbar-brand"><a href="index.html" class="d-inline-block"><img src="<c:url value='https://ggg.com.vn/wp-content/themes/ggg-webportal/logo.png'/>" alt="" style="width:170px; height:40px"></a></div>
	</div>
	<!-- /main navbar -->
	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content d-flex justify-content-center align-items-center">
				...
				<div class="flex-fill">
					...
					<div class="text-center mb-3">
						<h1 class="error-title">${errorStatus}</h1>
						<h5>${errorMsg}</h5>
					</div>
					<!-- /error title -->
			...
			<div class="navbar navbar-expand-lg navbar-light">
				<div class="navbar-collapse collapse" id="navbar-footer"><span class="navbar-text">&copy; 2019. <a href="#" target="_blank">Created By KEYSOFT</a></span></div>
			</div>
			<!-- /footer -->
