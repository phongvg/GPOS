...
<head>
	...
	<script src="<c:url value='/themes/admin/assets/js/cag/group-param/param_form.js'/>"></script>
</head>
			...
			<div class="card-body">
				...
				<fieldset class="mb-3">
					...
					<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
						<li class="nav-item"><a href="<c:url value="/cag/group-param/form?id=${paramDto.groupParamId}"/>" class="nav-link"><i class="icon-file-text2 mr-2"></i><fmt:message key="tab.group.param"/></a></li>
						<li class="nav-item"><a href="#" class="nav-link active"><i class="icon-hammer-wrench mr-2"></i><fmt:message key="tab.param"/></a></li>
						<li class="nav-item"><a href="<c:url value="/cag/group-param/sync-to-restaurant?groupParamId=${paramDto.groupParamId}"/>" class="nav-link"><i class="icon-flip-vertical3 mr-2"></i><fmt:message key="tab.so.apply"/></a></li>
					</ul>
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-12 text-right px-4">
										<a href="<c:url value="/cag/group-param/param-list?groupParamId=${paramDto.groupParamId}"/>" id="back" class="btn btn-light"><i class="icon-point-left "></i>&nbsp;&nbsp;&nbsp;<fmt:message key="button.back"/></a>
