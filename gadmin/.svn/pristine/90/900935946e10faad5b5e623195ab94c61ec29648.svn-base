...
<head>
    <title><fmt:message key="sync.file.title"/></title>
...
<!-- Content area -->
<div class="content">
	<form:form id="restaurantForm" method="post" action="${ctx}/res/sync-file" modelAttribute="restaurant">
	<input type="hidden" id="refId" value="-1"/>
	<input type="hidden" id="refType" value="res"/>
	<!-- Basic layout-->
	<div class="card">
		<div class="card-header header-elements-inline">
			<span class="text-uppercase font-size-lg font-weight-bold"><fmt:message key="sync.file.title"/></span>
		...
		<div class="card-body">
			<p class="mb-4"><fmt:message key="sync.file.title.description"/></p>
		...
		<div class="tab-content">
			...
			<div class="d-flex justify-content-end align-items-center">
				<button type="button" id="sync-to-file-res" class="btn btn-primary ml-3"><fmt:message key="button.sync"/><i class="icon-database-insert ml-2"></i></button>
			</div>
		</div>
	</div>
	<!-- /basic layout -->
