var FormComponent = function() {
	...
	var checkCode = function() {
		$('#code').on('keyup', function(e){
			...
			if(code != ''){
				$.ajax({
					url: contextPath + '/kaloGroup/checkCode',
	...
	var validateForm = function(){
		$('#kaloGroupForm').validate({
			...
			messages: {
				"code": {
					required: "Bắt buộc nhập mã nhóm kalo",
					maxlength: "Hãy nhập tối đa 50 ký tự",
				},
				"name": {
					required: "Bắt buộc nhập tên nhóm kalo",
					maxlength: "Chỉ nhập tối đa 512 ký tự",
				},
				"maxKalo": {
					number: "maxKalo phải là số",
					maxlength: "Chỉ nhập tối đa 5 ký tự",
				}
			}
		});
	}
