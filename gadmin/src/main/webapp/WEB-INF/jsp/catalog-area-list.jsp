			...
			<div class="card">
				...
				<div class="card-body">
					<div class="list-icons" style="float: right">
						<a href="<c:url value='/area/catalog-form?kId=${criteria.kds.id}'/>" class="btn btn-sm btn-primary" title="<fmt:message key="button.add"/>" style=" margin-top: -25%; margin-bottom: 15%"><i class="icon-plus22"></i><fmt:message key="button.add"/></a>
	               	</div>
		               	...
		               	<table class="table table-bordered table-striped">
		               		<thead>
		                		<tr class="table-success">
		                			<th>#</th>
		                			<th><fmt:message key="area.code"/></th>
		               		...
		               		<tbody>
			               		...
			               		<c:forEach items="${page.content }" var="area" varStatus="cnt">
			                		<tr>
			                			...
			                			<td class="text-left">
											<div class="list-icons">
						                		<a href="<c:url value='/area/catalog-form?id=${area.id}&kId=${criteria.kds.id}'/>" class="list-icons-item text-primary-600" title="<fmt:message key='button.edit'/>" data-container="body"><i class="icon-pencil7"></i></a>
