...
<form:form id="foodItemListForm" modelAttribute="criteria" action="${ctx}/cag/so/foodItem/list"  method="post">
				...
				<div class="tab-content">
					...
					<div class="card">
						...
						<ul class="nav nav-tabs">
							<li class="nav-item"><a href="<c:url value="/cag/so/menu/list?soId=${criteria.soId}"/>" class="nav-link"><fmt:message key="tab.so.menu"/></a></li>
							...
							<li class="nav-item"><a href="#" class="nav-link active"><fmt:message key="tab.so.foodItem"/></a></li>
						</ul>
						<div class="card-body">
							<%-- <div class="list-icons" style="float: right"><a href="<c:url value='/cag/so/foodItem/form?soId=${criteria.soId}'/>" class="btn btn-sm btn-primary" title="<fmt:message key="button.add"/>" style=" margin-top: -25%; margin-bottom: 15%"><i class="icon-plus22"></i><fmt:message key="button.add"/></a></div> --%>
				               	...
				               	<table class="table table-bordered table-striped">
									...
									<tbody>
										<c:if test="${empty page.content}">
											<tr>
												<td colspan="4" class="text-center font-weight-bold text-danger"><fmt:message key="not.data"/></td>
											</tr>
										</c:if>
