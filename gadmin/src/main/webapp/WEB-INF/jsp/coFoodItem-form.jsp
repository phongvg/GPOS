...
<head>
	...
	<script src="<c:url value='/themes/admin/assets/js/res.coFoodItem_form.js'/>"></script>	
	...
	<script src="<c:url value='/themes/admin/assets/js/res.foodItem_related_selector.js'/>"></script>
	<script src="<c:url value='/themes/admin/global_assets/js/plugins/forms/selects/bootstrap_multiselect.js'/>"></script>
	<script src="<c:url value='/themes/admin/assets/js/res.foodItem_size_selector.js'/>"></script>
		...
		<div class="card-body">
			...
			<fieldset class="mb-3">
				...
				<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
					<li class="nav-item"><a href="<c:url value="/restaurant/form?rCode=${coFoodItem.restaurantCode}"/>" class="nav-link"><i class="icon-file-text2 mr-2"></i><fmt:message key="tab.restaurant"/></a></li>
					<li class="nav-item"><a href="<c:url value="/res/so/menu/list?resCode=${coFoodItem.restaurantCode}"/>" class="nav-link"><i class="icon-hammer-wrench mr-2"></i><fmt:message key="tab.menu"/></a></li>
					<li class="nav-item"><a href="<c:url value="/co/form?rCode=${coFoodItem.restaurantCode}"/>" class="nav-link active"><i class="icon-clipboard3 mr-2"></i><fmt:message key="tab.co"/></a></li>
					<li class="nav-item"><a href="<c:url value="/kds/form?rCode=${coFoodItem.restaurantCode}"/>" class="nav-link"><i class="icon-tree7 mr-2"></i><fmt:message key="tab.kitchen.fax"/></a></li>
					<li class="nav-item"><a href="<c:url value="/group-param/form?rCode=${coFoodItem.restaurantCode}"/>" class="nav-link"><i class="icon-equalizer2 mr-2"></i><fmt:message key="tab.param"/></a></li>
					<li class="nav-item"><a href="<c:url value="/restaurant/device?rCode=${coFoodItem.restaurantCode}"/>" class="nav-link"><i class="icon-equalizer mr-2"></i><fmt:message key="tab.device"/></a></li>
					<%-- <li class="nav-item"><a href="<c:url value="/advanced/list?rCode=${coFoodItem.restaurantCode}"/>" class="nav-link" ><i class="icon-grid4 mr-2"></i><fmt:message key="tab.advance"/></a></li>
					<li class="nav-item"><a href="<c:url value="/reportMenu/list?rCode=${coFoodItem.restaurantCode}"/>" class="nav-link"><i class="icon-file-stats mr-2"></i><fmt:message key="tab.report"/></a></li> --%>
					<li class="nav-item"><a href="<c:url value="/res/kdsPlace/list?rCode=${coFoodItem.restaurantCode}"/>" class="nav-link"><i class="icon-tree7 mr-2"></i><fmt:message key="tab.kds"/></a></li>
				</ul>
					...
					<div class="card">
						<div class="card-header header-elements-inline"><span class="text-uppercase font-size-lg font-weight-bold"><fmt:message key="tab.menu.foodItem"/></span></div>
							<ul class="nav nav-tabs">
								<li class="nav-item"><a href="<c:url value='/co/form?rCode=${coFoodItem.restaurantCode }'/>" class="nav-link"><fmt:message key="tab.co"/></a></li>
								<li class="nav-item"><a href="<c:url value='/res/co/soCategory/list?rCode=${coFoodItem.restaurantCode}&cId=${coId}'/>" class="nav-link"><fmt:message key="tab.soCategory"/></a></li>
								<li class="nav-item"><a href="<c:url value='#'/>" class="nav-link active"><fmt:message key="tab.catalog.co.listFoodItem"/></a></li>
								<li class="nav-item"><a href="<c:url value='/restaurant/co-menu/configQrOrder/form?restaurantCode=${coFoodItem.restaurantCode}'/>" class="nav-link"><fmt:message key="tab.catalog.co.config.qr.order"/></a></li>
							</ul>
						<div class="card-body">
						<form:form class="form-validate-jquery" id="coFoodItemForm" action="${ctx}/coFoodItem/save" method="POST" modelAttribute="coFoodItem"  enctype="multipart/form-data" >
						...
						<input type="hidden" name="coId" value="<c:url value="${coId}"/>">
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									...
									<select class="select2-co-food-item" name="foodItem.id" data-placeholder="Chọn món ăn" data-fouc>
			        				</select>
								</div>
							</div>
							<div class="col-md-3">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label><fmt:message key="menu.kaloGroup" /><span class="help-block"> *</span></label>
						...
						<div class="row">
							...
							<div class="col-12 text-right px-4">
								<a href='<c:url value="/coFoodItem/list?rCode=${coFoodItem.restaurantCode}"/>'><button type="button" class="btn btn-light" id="back"><fmt:message key="button.back"/> <i class="icon-reload-alt ml-2"></i></button></a>
