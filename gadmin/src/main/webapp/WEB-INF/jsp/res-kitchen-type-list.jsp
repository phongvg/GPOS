...
<!-- Content area -->
<div class="content">
	<form:form id="kitchenTypeForm" modelAttribute="criteria" action="${ctx}/res/kitchenType/list"  method="post">
	<form:hidden path="id"/>
			...
			<div class="card">
				...
				<security:authorize access="hasRole('ROLE_RES_CONFIG_EDIT')">
					<div class="list-icons" style="float: right">
						<a href="<c:url value='/res/kitchenType/form?rCode=${criteria.restaurantCode}'/>" class="btn btn-sm btn-primary" title="<fmt:message key="button.add"/>" style=" margin-top: -25%; margin-bottom: 15%"><i class="icon-plus22"></i><fmt:message key="button.add"/></a>
	               	</div>
	            </security:authorize>
		               	...
		               	<table class="table table-bordered table-striped">
		               		<thead>
		                		<tr class="table-success">
		                			...
		                			<th style="width: 80%"><fmt:message key="kitchenType.name"/></th>
			               		...
			               		<c:forEach items="${page.content }" var="item" varStatus="cnt">
			                		<tr>
			                			...
			                			<td class="text-center">
											<div class="list-icons">
						                		<a href="<c:url value='/res/kitchenType/form?id=${item.id}&rCode=${item.restaurantCode}'/>" class="list-icons-item text-primary-600" title="<fmt:message key='button.edit'/>" data-container="body"><i class="icon-pencil7"></i></a>
