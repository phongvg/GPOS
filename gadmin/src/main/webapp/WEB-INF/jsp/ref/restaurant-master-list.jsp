...
<head>
    ...
    <meta name="menu" content="restaurantMasterMenu"/>
    <script src="<c:url value='/themes/admin/global_assets/js/plugins/notifications/bootbox.min.js'/>"></script>
	<script src="<c:url value='/themes/admin/global_assets/js/plugins/forms/selects/select2.min.js'/>"></script>
	<script src="<c:url value='/themes/admin/assets/js/ref/restaurant_master_list.js'/>"></script>
</head>


<div class="content">
	<form:form id="restaurantMasterForm" modelAttribute="criteria" action="${ctx}/ref/restaurantMaster/list"  method="post">
	<!-- \Searching -->
	<div class="card">
		...
		<div class="card-body">
			<div class="row">
				<div class="col-md-4 col-sm-12">
				   <label><fmt:message key="restaurantMaster.code"/></label>
				   <input class="form-control" type="text" value="${criteria.code}" name="code" placeholder="Nhập mã nhà hàng ..."/>
				</div>
				<div class="col-md-4 col-sm-12">
				   <label><fmt:message key="restaurantMaster.name"/></label>
				   <input class="form-control" type="text" value="${criteria.name}" name="name" placeholder="Nhập tên nhà hàng ..."/>
				</div>
				<div class="col-md-4 col-sm-12">
	...
	<div class="card">
		<div class="card-header header-elements-inline">
			<span class="text-uppercase font-size-lg font-weight-bold"><fmt:message key="restaurantMaster.list"/></span>
			
			<div class="header-elements">
				<div class="list-icons">
					<security:authorize access="hasAnyRole('ROLE_ADMIN,ROLE_GUESTTYPE_ALL,ROLE_GUESTTYPE_SYNC')">
						<a href="<c:url value='/restaurantMaster/sync-from-rk7'/>" id="btnSyncFromRk7" class="btn btn-sm btn-primary" ><i class="icon-download mr-2"></i><fmt:message key="button.sync.from.server"/></a>
					</security:authorize>
					<security:authorize access="hasAnyRole('ROLE_ADMIN,ROLE_GUESTTYPE_ALL,ROLE_GUESTTYPE_RES_SYNC')">
		...
		<div class="card-body"><fmt:message key="restaurantMaster.list.desc"/></div>
		<div class="table-responsive">
			<table class="table table-bordered table-striped">
				<thead>
					<tr class="table-success">
						<th>#</th>
						<th><fmt:message key="restaurantMaster.code"/></th>
						<th><fmt:message key="restaurantMaster.name"/></th>
