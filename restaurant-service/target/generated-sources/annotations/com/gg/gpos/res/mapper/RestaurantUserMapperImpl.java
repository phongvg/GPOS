...
public class RestaurantUserMapperImpl implements RestaurantUserMapper {
    ...
    @Override
    public RestaurantUser dtoToEntity(RestaurantUserDto restaurantUserDto) {
        ...
        restaurantUser.setId( restaurantUserDto.getId() );
        restaurantUser.setUsername( restaurantUserDto.getUsername() );
        restaurantUser.setRestaurant( restaurantDtoToRestaurant( restaurantUserDto.getRestaurant() ) );

        return restaurantUser;
    }

    @Override
    public RestaurantUserDto entityToDto(RestaurantUser restaurantUser) {
        ...
        restaurantUserDto.setRestaurant( restaurantToRestaurantDto( restaurantUser.getRestaurant() ) );
    ...
    public RestaurantDto restaurantToRestaurantDto(Restaurant restaurant) {
        ...
        restaurantDto.setProvinceBrand( null );
