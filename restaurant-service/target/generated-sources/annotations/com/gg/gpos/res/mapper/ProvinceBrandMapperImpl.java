...
@Component
public class ProvinceBrandMapperImpl implements ProvinceBrandMapper {

    @Override
    public ProvinceBrand dtoToEntity(ProvinceBrandDto provinceBrandDto) {
    ...
    @Override
    public ProvinceBrandDto entityToDto(ProvinceBrand provinceBrand) {
    ...
    protected Restaurant restaurantDtoToRestaurant(RestaurantDto restaurantDto) {
        ...
        restaurant.setProvinceBrand( dtoToEntity( restaurantDto.getProvinceBrand() ) );
    ...
    protected List<ProvinceBrand> provinceBrandDtoListToProvinceBrandList(List<ProvinceBrandDto> list) {
        ...
        for ( ProvinceBrandDto provinceBrandDto : list ) {
            list1.add( dtoToEntity( provinceBrandDto ) );
        }
    ...
    protected RestaurantDto restaurantToRestaurantDto(Restaurant restaurant) {
        ...
        restaurantDto.setProvinceBrand( entityToDto( restaurant.getProvinceBrand() ) );
    ...
    protected List<ProvinceBrandDto> provinceBrandListToProvinceBrandDtoList(List<ProvinceBrand> list) {
        ...
        for ( ProvinceBrand provinceBrand : list ) {
            list1.add( entityToDto( provinceBrand ) );
        }
