...
@Component
public class DistrictBrandMapperImpl implements DistrictBrandMapper {

    @Override
    public DistrictBrand dtoToEntity(DistrictBrandDto districtBrandDto) {
    ...
    @Override
    public DistrictBrandDto entityToDto(DistrictBrand districtBrand) {
    ...
    protected Restaurant restaurantDtoToRestaurant(RestaurantDto restaurantDto) {
        ...
        restaurant.setDistrictBrand( dtoToEntity( restaurantDto.getDistrictBrand() ) );
    ...
    protected List<DistrictBrand> districtBrandDtoListToDistrictBrandList(List<DistrictBrandDto> list) {
        ...
        for ( DistrictBrandDto districtBrandDto : list ) {
            list1.add( dtoToEntity( districtBrandDto ) );
        }
    ...
    protected RestaurantDto restaurantToRestaurantDto(Restaurant restaurant) {
        ...
        restaurantDto.setDistrictBrand( entityToDto( restaurant.getDistrictBrand() ) );
    ...
    protected List<DistrictBrandDto> districtBrandListToDistrictBrandDtoList(List<DistrictBrand> list) {
        ...
        for ( DistrictBrand districtBrand : list ) {
            list1.add( entityToDto( districtBrand ) );
        }
