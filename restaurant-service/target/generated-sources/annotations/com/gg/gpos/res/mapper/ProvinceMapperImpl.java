...
public class ProvinceMapperImpl implements ProvinceMapper {
    ...
    protected List<Province> provinceDtoListToProvinceList(List<ProvinceDto> list) {
        ...
        for ( ProvinceDto provinceDto : list ) {
            list1.add( dtoToEntity( provinceDto ) );
        }
    ...
    protected ProvinceBrand provinceBrandDtoToProvinceBrand(ProvinceBrandDto provinceBrandDto) {
        ...
        provinceBrand.setProvince( dtoToEntity( provinceBrandDto.getProvince() ) );
    ...
    protected District districtDtoToDistrict(DistrictDto districtDto) {
        ...
        district.setProvince( dtoToEntity( districtDto.getProvince() ) );
    ...
    protected List<ProvinceDto> provinceListToProvinceDtoList(List<Province> list) {
        ...
        for ( Province province : list ) {
            list1.add( entityToDto( province ) );
        }
    ...
    protected ProvinceBrandDto provinceBrandToProvinceBrandDto(ProvinceBrand provinceBrand) {
        ...
        provinceBrandDto.setProvince( entityToDto( provinceBrand.getProvince() ) );
    ...
    protected DistrictDto districtToDistrictDto(District district) {
        ...
        districtDto.setProvince( entityToDto( district.getProvince() ) );
