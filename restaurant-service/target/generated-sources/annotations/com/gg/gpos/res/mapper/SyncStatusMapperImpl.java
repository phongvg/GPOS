...
@Component
public class SyncStatusMapperImpl implements SyncStatusMapper {

    @Override
    public SyncStatus dtoToEntity(SyncStatusDto syncStatusDto) {
    ...
    @Override
    public SyncStatusDto entityToDto(SyncStatus syncStatus) {
        if ( syncStatus == null ) {
            return null;
        }
    ...
    public RestaurantDto restaurantToRestaurantDto(Restaurant restaurant) {
        ...
        restaurantDto.setSyncStatus( null );
    ...
    protected List<SyncStatus> syncStatusDtoListToSyncStatusList(List<SyncStatusDto> list) {
        ...
        for ( SyncStatusDto syncStatusDto : list ) {
            list1.add( dtoToEntity( syncStatusDto ) );
        }
